...
public class TicTacToe {
    ...
    protected String getRules() {
        ...
        builder.append("Los jugadores se turnan para marcar un cuadro. Solo cuadrados \n");
        builder.append("que no esten marcados se pueden jugar. Una vez que un jugador tiene \n");
        builder.append("marcados tres cuadros consecutivos, gana! Si todos los cuadrados \n");
        builder.append("estan marcados pero no son 3 consecutivos, Se declara empate.\n");
        builder.append("A jugar se ha dicho! \n\n");
    ...
    protected String drawBoard() {
        StringBuilder builder = new StringBuilder("Tablero: \n");
        for (int i = 0; i < 3; i++) {
            for (int i1 = 0; i1 < 3; i1++) {
